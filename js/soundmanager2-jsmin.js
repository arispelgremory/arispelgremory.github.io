...
(function (h, g) {
  function J(sb, J) {
    ...
    this.defaultOptions = { autoLoad: !1, autoPlay: !1, from: null, loops: 1, onid3: null, onerror: null, onload: null, whileloading: null, onplay: null, onpause: null, onresume: null, whileplaying: null, onposition: null, onstop: null, onfinish: null, multiShot: !0, multiShotEvents: !1, position: null, pan: 0, playbackRate: 1, stream: !0, to: null, type: null, usePolicyFile: !1, volume: 100 };
    ...
    this.setup = function (b) {
      ...
      if (!Pa && va)
        if (c.setupOptions.ignoreMobileRestrictions) L.push(z.ignoreMobile);
        ...
        else if ((Ra && !v.match(/android\s2\.3/i)) || !Ra) c._wD(z.globalHTML5), (B = !0);
      b && (d && Z && b.url !== g && c.beginDelayedInit(), Z || b.url === g || "complete" !== m.readyState || setTimeout(P, 1));
      Pa = !0;
      return c;
    };
    ...
    this.createSound = function (b, d) {
      ...
      f.id
        .toString()
        .charAt(0)
        .match(/^[0-9]$/) && c._wD("soundManager.createSound(): " + t("badID", f.id), 2);
    ...
    this.disable = function (b) {
      ...
      y = !0;
      p("shutdown", 1);
      for (d = c.soundIDs.length - 1; 0 <= d; d--) Ga(c.sounds[c.soundIDs[d]]);
      Ga(c);
      Y(b);
      x.remove(h, "load", R);
      return !0;
    ...
    this.onready = function (b, d) {
      if ("function" === typeof b) q && c._wD(t("queue", "onready")), d || (d = h), Ba("onready", b, d), O();
      else throw t("needFunction", "onready");
      return !0;
    };
    this.ontimeout = function (b, d) {
      if ("function" === typeof b) q && c._wD(t("queue", "ontimeout")), d || (d = h), Ba("ontimeout", b, d), O({ type: "ontimeout" });
    ...
    -1 !== ia.indexOf("sm2-debug=alert") &&
      (this._writeDebug = function (c) {
        h.alert(c);
      });
    ...
    this.reboot = function (b, d) {
      ...
      Pa = !1;
      if (b) H = [];
      else for (e in H) if (H.hasOwnProperty(e)) for (a = 0, f = H[e].length; a < f; a++) H[e][a].fired = !1;
    ...
    V = function (b) {
      ...
      this.load = function (b) {
        ...
        if (sa(e)) (d = a._setup_html5(e)), d._called_load ? c._wD(a.id + ": Ignoring request to load again") : ((a._html5_canplay = !1), a.url !== e.url && (c._wD(p("manURL") + ": " + e.url), (a._a.src = e.url), a.setPosition(0)), (a._a.autobuffer = "auto"), (a._a.preload = "auto"), (a._a._called_load = !0));
          ...
          try {
            ...
            p("smError", 2), C("onload", !1), T({ type: "SMSOUND_LOAD_JS_EXCEPTION", fatal: !0 });
          }
        }
        a.url = e.url;
        return a;
        ...
        a.paused && 0 <= a.position && (!a._iO.serverURL || 0 < a.position)
          ...
          : ((a._iO = A(b, a._iO)),
            ((!a.isHTML5 && null !== a._iO.position && 0 < a._iO.position) || (null !== a._iO.from && 0 < a._iO.from) || null !== a._iO.to) &&
              ...
              a.isHTML5 && !a._html5_canplay ? (c._wD(e + "Beginning load for non-zero offset case"), a.load({ _oncanplay: f })) : a.isHTML5 || a.loaded || (a.readyState && 2 === a.readyState) || (c._wD(e + "Preloading for non-zero offset case"), a.load({ onload: f })),
              (a._iO = y())),
            (!a.instanceCount || a._iO.multiShotEvents || (a.isHTML5 && a._iO.multiShot && !B) || (!a.isHTML5 && 8 < n && !a.getAutoPlay())) && a.instanceCount++,
            ...
            a.isHTML5
              ? 2 > a.instanceCount
                ? (m(), (e = a._setup_html5()), a.setPosition(a._iO.position), e.play())
                : (c._wD(a.id + ": Cloning Audio() for instance #" + a.instanceCount + "..."),
                  ...
                  x.add(k, "ended", F),
                  a._iO.volume !== g && (k.volume = Math.max(0, Math.min(1, a._iO.volume / 100))),
                  a.muted && (k.muted = !0),
                  a._iO.position ? x.add(k, "canplay", h) : k.play())
              : ((f = l._start(a.id, a._iO.loops || 1, 9 === n ? a.position : a.position / 1e3, a._iO.multiShot || !1)), 9 !== n || f || (c._wD(e + "No sound hardware, or 32-sound ceiling hit", 2), a._iO.onplayerror && a._iO.onplayerror.apply(a))));
        return a;
      };
      this.stop = function (b) {
        var d = a._iO;
      ...
      this.setPlaybackRate = function (b) {
        var d = Math.max(0.5, Math.min(4, b));
      ...
      this.togglePause = function () {
        ...
        if (0 === a.playState) return a.play({ position: 9 !== n || a.isHTML5 ? a.position / 1e3 : a.position }), a;
      ...
      this.clearOnPosition = function (a, b) {
        var c;
        a = parseInt(a, 10);
        if (!isNaN(a)) for (c = 0; c < D.length; c++) a !== D[c].position || (b && b !== D[c].method) || (D[c].fired && v--, D.splice(c, 1));
      };
      this._processOnPosition = function () {
        var b, c;
        b = D.length;
        if (!b || !a.playState || v >= b) return !1;
        for (--b; 0 <= b; b--) (c = D[b]), !c.fired && a.position >= c.position && ((c.fired = !0), v++, c.method.apply(c.scope, [c.position]));
        return !0;
      };
      this._resetOnPosition = function (a) {
        ...
        b = D.length;
        if (!b) return !1;
        for (--b; 0 <= b; b--) (c = D[b]), c.fired && a <= c.position && ((c.fired = !1), v--);
        return !0;
      };
      y = function () {
        var b = a._iO,
      ...
      this._setup_html5 = function (b) {
        ...
        if (c) {
          if (c._s)
            if (B) c._s && c._s.playState && !e && c._s.stop();
            else if (!B && d === decodeURI(u)) return a._apply_loop(c, b.loops), c;
      ...
      h = function () {
        ...
        for (b in I) I.hasOwnProperty(b) && a._a && a._a.addEventListener(b, I[b], !1);
        return !0;
      };
      k = function () {
        var b;
        ...
        for (b in I) I.hasOwnProperty(b) && a._a && a._a.removeEventListener(b, I[b], !1);
      };
      ...
      this._onfinish = function () {
        ...
        a.instanceCount &&
          (a.instanceCount--,
          a.instanceCount || (Xa(), (a.playState = 0), (a.paused = !1), (a.instanceCount = 0), (a.instanceOptions = {}), (a._iO = {}), F(), a.isHTML5 && (a.position = 0)),
      ...
      this._whileplaying = function (b, c, d, e, f) {
        ...
        !a.isHTML5 && 8 < n && (k.usePeakData && c !== g && c && (a.peakData = { left: c.leftPeak, right: c.rightPeak }), k.useWaveformData && d !== g && d && (a.waveformData = { left: d.split(","), right: e.split(",") }), k.useEQData && f !== g && f && f.leftEQ && ((b = f.leftEQ.split(",")), (a.eqData = b), (a.eqData.left = b), f.rightEQ !== g && f.rightEQ && (a.eqData.right = f.rightEQ.split(","))));
    ...
    Q = { onready: 1, ontimeout: 1, defaultOptions: 1, flash9Options: 1, movieStarOptions: 1 };
    Aa = function (b, d) {
      var e,
        a = !0,
        f = d !== g,
      ...
      if (b === g) {
        ...
        for (e in Q) Q.hasOwnProperty(e) && ("object" === typeof c[e] ? a.push(e + ": {...}") : c[e] instanceof Function ? a.push(e + ": function() {...}") : a.push(e));
        c._wD(t("setup", a.join(", ")));
        return !1;
      }
      for (e in b)
        if (b.hasOwnProperty(e))
          if ("object" !== typeof b[e] || null === b[e] || b[e] instanceof Array || b[e] instanceof RegExp) f && Q[d] !== g ? (c[d][e] = b[e]) : h[e] !== g ? ((c.setupOptions[e] = b[e]), (c[e] = b[e])) : Q[e] === g ? (K(t(c[e] === g ? "setupUndef" : "setupError", e), 2), (a = !1)) : c[e] instanceof Function ? c[e].apply(c, b[e] instanceof Array ? b[e] : [b[e]]) : (c[e] = b[e]);
          else if (Q[e] === g) K(t(c[e] === g ? "setupUndef" : "setupError", e), 2), (a = !1);
    ...
    I = {
      ...
      progress: r(function (b) {
        ...
        if (k && k.length) {
          e = 0;
          for (a = k.length; e < a; e++) d.buffered.push({ start: 1e3 * k.start(e), end: 1e3 * k.end(e) });
    ...
    sa = function (b) {
      return b && (b.type || b.url || b.serverURL) ? (b.serverURL || (b.type && ha(b.type)) ? !1 : b.type ? ea({ type: b.type }) : ea({ url: b.url }) || c.html5Only || b.url.match(/data:/i)) : !1;
    };
    ta = function (b) {
      var d;
    ...
    ea = function (b) {
      ...
      if (!M) {
        M = [];
        for (a in e) e.hasOwnProperty(a) && (M.push(a), e[a].related && (M = M.concat(e[a].related)));
        M = new RegExp("\\.(" + M.join("|") + ")(\\?.*)?$", "i");
      }
      (a = d ? d.toLowerCase().match(M) : null) && a.length ? (a = a[1]) : b && ((d = b.indexOf(";")), (a = (-1 !== d ? b.substr(0, d) : b).substr(6)));
      a && c.html5[a] !== g ? (d = c.html5[a] && !ha(a)) : ((b = "audio/" + a), (d = c.html5.canPlayType({ type: b })), (d = (c.html5[a] = d) && c.html5[b] && !ha(b)));
      return d;
    };
    jb = function () {
      function b(a) {
    ...
    Ja = function () {
      var b = t("fbHandler"),
        d = c.getMoviePercent(),
        e = { type: "FLASHBLOCK" };
      c.html5Only || (c.ok() ? (c.didFlashBlock && c._wD(b + ": Unblocked"), c.oMC && (c.oMC.className = [U(), "movieContainer", "swf_loaded" + (c.didFlashBlock ? " swf_unblocked" : "")].join(" "))) : (u && ((c.oMC.className = U() + " movieContainer " + (null === d ? "swf_timedout" : "swf_error")), c._wD(b + ": " + t("fbTimeout") + (d ? " (" + t("fbLoaded") + ")" : ""))), (c.didFlashBlock = !0), O({ type: "ontimeout", ignoreInit: !0, error: e }), T(e)));
    };
    Ba = function (b, c, e) {
      H[b] === g && (H[b] = []);
      H[b].push({ method: c, scope: e || null, fired: !1 });
    };
    O = function (b) {
      b || (b = { type: c.ok() ? "onready" : "ontimeout" });
      if ((!q && b && !b.ignoreInit) || ("ontimeout" === b.type && (c.ok() || (y && !b.ignoreInit)))) return !1;
      var d = { success: b && b.ignoreInit ? c.ok() : !y },
        e = b && b.type ? H[b.type] || [] : [],
        a = [],
        f,
        d = [d],
    ...
    R = function () {
      h.setTimeout(function () {
        ...
        c.waitForWindowLoad && x.add(h, "load", R);
      }, 1);
    };
    Na = function () {
      if (G !== g) return G;
      ...
      else if (a !== g && !v.match(/MSAppHost/i)) {
        try {
    ...
    hb = function () {
      ...
      if (c.useHTML5Audio && c.hasHTML5) for (d in ((da = !0), e)) e.hasOwnProperty(d) && e[d].required && (c.html5.canPlayType(e[d].type) ? c.preferFlash && (c.flash[d] || c.flash[e[d].type]) && (b = !0) : ((da = !1), (b = !0)));
    ...
    gb = function () {
      var b;
      if (null === ca || qa) for (b = c.soundIDs.length - 1; 0 <= b; b--) c.sounds[c.soundIDs[b]].isHTML5 && c.sounds[c.soundIDs[b]]._hasTimer && c.sounds[c.soundIDs[b]]._onTimer();
    ...
    this._externalInterfaceOK = function (b) {
      if (!c.swfLoaded) {
        ...
        wa = !1;
        Ta && lb();
        b && b.replace(/\+dev/i, "") === c.versionNumber.replace(/\+dev/i, "")
          ? setTimeout(ya, N ? 100 : 1)
          : ((d = 'soundManager: Fatal: JavaScript file build "' + c.versionNumber + '" does not match Flash SWF build "' + b + '" at ' + c.url + ". Ensure both are up-to-date."),
            setTimeout(function () {
              throw Error(d);
            }, 0));
      }
    ...
    na = function (b, d) {
      ...
      k = { name: b, id: b, src: d, quality: "high", allowScriptAccess: c.allowScriptAccess, bgcolor: c.bgColor, pluginspage: vb + "www.macromedia.com/go/getflashplayer", title: "JS/Flash audio component (SoundManager 2)", type: "application/x-shockwave-flash", wmode: c.wmode, hasPriority: "true" };
      ...
      l = U();
      if ((k = ma()))
        if (((c.oMC = E(c.movieID) || m.createElement("div")), c.oMC.id)) (q = c.oMC.className), (c.oMC.className = (q ? q + " " : "movieContainer") + (l ? " " + l : "")), c.oMC.appendChild(f), N && ((p = c.oMC.appendChild(m.createElement("div"))), (p.className = "sm2-object-box"), (p.innerHTML = r)), (X = !0);
        else {
          c.oMC.id = c.movieID;
          c.oMC.className = "movieContainer " + l;
          p = l = null;
          c.useFlashBlock || (c.useHighPerformance ? (l = { position: "fixed", width: "8px", height: "8px", bottom: "0px", left: "0px", overflow: "hidden" }) : ((l = { position: "absolute", width: "6px", height: "6px", top: "-9999px", left: "-9999px" }), n && (l.left = Math.abs(parseInt(l.left, 10)) + "px")));
    ...
    Y = function (b) {
      if (q) return !1;
      if (c.html5Only) return p("sm2Loaded", 1), (q = !0), R(), C("onload", !0), !0;
      var d = !0,
        e;
      (c.useFlashBlock && c.flashLoadTimeout && !c.getMoviePercent()) || (q = !0);
      e = { type: !G && u ? "NO_FLASH" : "INIT_TIMEOUT" };
      c._wD("SoundManager 2 " + (y ? "failed to load" : "loaded") + " (" + (y ? "Flash security/load error" : "OK") + ") " + String.fromCharCode(y ? 10006 : 10003), y ? 2 : 1);
      y || b ? (c.useFlashBlock && c.oMC && (c.oMC.className = U() + " " + (null === c.getMoviePercent() ? "swf_timedout" : "swf_error")), O({ type: "ontimeout", error: e, ignoreInit: !0 }), C("onload", !1), T(e), (d = !1)) : C("onload", !0);
      y || (c.waitForWindowLoad && !ja ? (p("waitOnload"), x.add(h, "load", R)) : (c.waitForWindowLoad && ja && p("docLoaded"), R()));
      return d;
    };
    Za = function () {
      var b,
    ...
    ya = function () {
      ...
      try {
        ...
        return c._wD("js/flash exception: " + b.toString()), C("jstoflash", !1), T({ type: "JS_TO_FLASH_EXCEPTION", fatal: !0 }), Ha(!0), Y(), !1;
      }
      Y();
    ...
    P = function () {
      ...
      Za();
      Fa();
      !G && c.hasHTML5 && (c._wD("SoundManager 2: No Flash detected" + (c.useHTML5Audio ? ". Trying HTML5-only mode." : ", enabling HTML5."), 1), c.setup({ useHTML5Audio: !0, preferFlash: !1 }));
      jb();
      !G && u && (L.push(z.needFlash), c.setup({ flashLoadTimeout: 1 }));
      m.removeEventListener && m.removeEventListener("DOMContentLoaded", P, !1);
      la();
      return !0;
    };
    La = function () {
      "complete" === m.readyState && (P(), m.detachEvent("onreadystatechange", La));
      return !0;
    };
    Ea = function () {
      ja = !0;
    ...
    x.add(h, "load", S);
    x.add(h, "load", Ea);
    m.addEventListener ? m.addEventListener("DOMContentLoaded", P, !1) : m.attachEvent ? m.attachEvent("onreadystatechange", La) : (C("onload", !1), T({ type: "NO_DOM2_EVENTS", fatal: !0 }));
  }
  ...
  "object" === typeof module && module && "object" === typeof module.exports
    ? ((module.exports.SoundManager = J), (module.exports.soundManager = V))
